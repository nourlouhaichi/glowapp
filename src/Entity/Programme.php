...
class Programme
{
    ...
    #[ORM\OneToMany(mappedBy: 'idprog', targetEntity: Reservationprog::class, cascade: ['remove'])]
    private Collection $reservationprogs;

    #[ORM\ManyToOne(inversedBy: 'programs')]
    #[ORM\JoinColumn(name: 'user_cin', referencedColumnName: 'cin')]
    private ?User $userprog = null;
...
public function getPlaceDispo()
    ...
    public function addComment(CommentProg $comment): static
    {
        if (!$this->comments->contains($comment)) {
            $comment->setUsercmnp($this->getUser());
    ...
    public function getUserprog(): ?User
    {
        return $this->userprog;
    }

    public function setUserprog(?User $userprog): static
    {

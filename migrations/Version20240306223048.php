 ...
 */
final class Version20240306223048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, idprog_id INT DEFAULT NULL, nbrplace INT NOT NULL, approuve TINYINT(1) NOT NULL, INDEX IDX_42C84955CC79C2F5 (idprog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20240229121417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE programme (id INT AUTO_INCREMENT NOT NULL, categorie_pro VARCHAR(255) DEFAULT NULL, plan_pro VARCHAR(255) NOT NULL, note_pro VARCHAR(255) NOT NULL, date_pro DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
